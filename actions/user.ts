...
export const subscribeToNewsletter = createActionHandler(
  async (_, { getUser }) => {
...
export const unsubscribeToNewsletter = createActionHandler(
  async (_, { getUser }) => {
    const user = await getUser();
...
export const createUnsubscribeLink = createActionHandler(
  async ({ email }) => {
...
export const unsubscribeToNewsletterUsingToken = createActionHandler(
  async ({ token }) => {
